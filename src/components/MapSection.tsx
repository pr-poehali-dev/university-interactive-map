...
export default function MapSection({ onSelectCampus }: MapSectionProps) {
    ...
    import('leaflet').then((L) => {
      ...
      CAMPUSES.forEach((campus) => {
        ...
        const markerHtml = `
          <div style="
            position: relative;
            width: ${isSpecial ? '42px' : '52px'};
            height: ${isSpecial ? '42px' : '52px'};
            display: flex;
            align-items: center;
          ...
          ">
            ...
            "></div>
            <div style="
              width: ${isSpecial ? '36px' : '46px'};
              height: ${isSpecial ? '36px' : '46px'};
              border-radius: 50%;
              background: ${campus.gradient};
        ...
        const icon = L.divIcon({
          html: markerHtml,
          className: '',
          iconSize: [isSpecial ? 42 : 52, isSpecial ? 42 : 52],
          iconAnchor: [isSpecial ? 21 : 26, isSpecial ? 21 : 26],
        });
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-200"
          ...
          {selectedCampus && (
            <div
              ...
              style={{
                left: Math.min(popupPos.x + 16, window.innerWidth > 600 ? popupPos.x + 16 : 16),
